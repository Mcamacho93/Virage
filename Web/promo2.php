...
<section>
	<div class="container tittle"> 
			<h3>MADRID - PARÍS 8 DÍAS</h3></div>
	<div class="slider2">

			<ul class="slides2">
				<li class="slide2"><div><img src="images/promo2_01.jpg"></div></li>
				<li class="slide2"><div><img src="images/promo2_02.jpg"></div></li>
				<li class="slide2"><div><img src="images/promo2_03.jpg"></div></li>
				<li class="slide2"><div><img src="images/promo2_04.jpg"></div></li>
...
<section class="container mainpromo">
	<div class="six columns info">
		...
		<p>Todos los Sábados <br> Del 20 de Junio al 19 Agosto 2014</p>
